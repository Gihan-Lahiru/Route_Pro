  ...
  return (
    <div className="terms-container">
      ...
      <ul>
        ...
        <li>
          You are responsible for keeping your account login information secure.
        </li>
      </ul>
      ...
      <ul>
        <li>
          All bookings are confirmed directly between the traveler and the
          service provider (driver or guide).
        </li>
      ...
      <ul>
        ...
        <li>
          Any driver or guide who receives an average rating below{" "}
          <strong>2.5</strong> will be flagged for admin review.
        </li>
        <li>
          Accounts that consistently perform poorly may be suspended or removed
          from the system.
        </li>
      </ul>
      ...
      <p>
        ...
        <strong>support@routepro.com</strong>
      </p>
    </div>
  );
}
